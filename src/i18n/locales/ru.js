        ...
        replies: [
          {
            ...
            tone: "plus",
            when: "3 недели назад",
            body: "+rep подтверждаю, insane IGL",
          },
          {
            id: "carry-reply-2",
            author: "stack_peek",
            tone: "plus",
            when: "3 недели назад",
            body: "40 bomb на последней карте, машина",
          },
        ],
      },
      {
        ...
        replies: [
          {
            ...
            tone: "plus",
            when: "1 месяц назад",
            body: "+rep трейдил 10 раз — ноль проблем, игнорь хейтера",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        replies: [
          ...
          },
          {
            ...
            tone: "plus",
            when: "2 месяца назад",
            body: "+rep глянь clutch-монтаж, потом пиши",
          },
        ],
      },
      {
