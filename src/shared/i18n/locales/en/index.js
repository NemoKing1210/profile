...
export default {
  ...
  caseOpen: {
    ...
    titleLine: "Tab title got seized. It’ll be released shortly.",
    pulseLine: "Cyan pulse applied. Looking rare already.",
    emptyLine: "You unboxed air. StatTrak™ emptiness — Factory New.",
    tipFallback: "Tip: dig around. This profile has more eggs than a farm.",
    ...
    tips: [
      "Tip: the Minecraft cover on Backloggd hides a diamond pickaxe.",
      "Tip: the infinite feed has a bottom. The footer panics when you find it.",
      "Tip: loop 99 of the echo drop a gift — ask gently.",
      "Tip: like every comment. Moderators unlock strange powers.",
      "Tip: the bug button leads somewhere musical. Come back after.",
