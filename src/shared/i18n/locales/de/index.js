...
export default {
  ...
  caseOpen: {
    ...
    titleLine: "Tab-Titel beschlagnahmt. Wird gleich freigelassen.",
    pulseLine: "Cyan-Puls aktiv. Sieht schon rare aus.",
    emptyLine: "Du hast Luft ausgepackt. StatTrak™-Leere — Factory New.",
    tipFallback: "Tipp: grab hier. Mehr Eier als auf einem Bauernhof.",
    ...
    tips: [
      "Tipp: das Minecraft-Cover auf Backloggd versteckt eine Diamantspitzhacke.",
      "Tipp: der Infinite-Feed hat ein Ende. Der Footer panikt, wenn du es findest.",
      "Tipp: bei Echo-Loop 99 fällt ein Geschenk — vorsichtig fragen.",
      "Tipp: like jeden Kommentar. Mods schalten seltsame Kräfte frei.",
      "Tipp: der Bug-Button führt irgendwohin Musikalischen. Danach zurückkommen.",
    ...
    rewards: {
      ...
      vacJoke: "Fake-VAC",
      titleGlitch: "Titel-Beschlagnahme",
