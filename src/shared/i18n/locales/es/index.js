...
export default {
  ...
  caseOpen: {
    ...
    titleLine: "Título de pestaña confiscado. Lo sueltan en un rato.",
    pulseLine: "Pulso cian activado. Ya se ve rare.",
    emptyLine: "Desempacaste aire. Vacío StatTrak™ — Factory New.",
    tipFallback: "Consejo: mira alrededor. Este perfil tiene más huevos que una granja.",
    ...
    tips: [
      "Consejo: la portada de Minecraft en Backloggd esconde un pico de diamante.",
      "Consejo: el feed infinito tiene fondo. El footer entra en pánico si lo hallas.",
      "Consejo: en el loop 99 del eco cae un regalo — pregunta con cuidado.",
      "Consejo: dale like a todos los comentarios. Los mods desbloquean poderes raros.",
      "Consejo: el botón de bugs lleva a un sitio musical. Vuelve después.",
